---
title: 'Exploratory Analyses NHB2: Identification as DV'
...
exploratory1_formula <- z_ingroup_minus_outgroup_identify ~ composite_political_orientation_z
...
exploratory1_bayesmodel_default <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_default_identify-as-DV"
  )
...
exploratory1_priordraws_default<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_priordraws_default_identify-as-DV"
  )
...
exploratory1_bayesmodel_informed <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_informed_identify-as-DV"
  )
...
exploratory1_priordraws_informed<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_priordraws_informed_identify-as-DV"
  )                            
```
...
# Define model equation
exploratory2_formula <- z_ingroup_minus_outgroup_identify ~ composite_political_orientation_z * condition
...
exploratory2_bayesmodel_default <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_default_identify-as-DV"
)
...
exploratory2_priordraws_default <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_priordraws_default_identify-as-DV")
...
exploratory2_bayesmodel_informed <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_informed_identify-as-DV"
)
...
exploratory2_priordraws_informed <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_priordraws_informed_identify-as-DV")
...
* M2: `mf_total_z`
* M3: `norms_total_z`
* Y: `z_ingroup_minus_outgroup_identify`
...
f4 <- brms::bf(z_ingroup_minus_outgroup_identify ~ composite_political_orientation_z + nfcc_total_z + mf_total_z + norms_total_z)
...
exploratory3_bayesmodel <- brm(
  ...
  warmup = 5000,
  chains = 4,
  file = "./model-fits/nhb2/exploratory3_bayesmodel_mediation_identify-as-DV")

# Define frequentist mediation model
medmodel <- "
    z_ingroup_minus_outgroup_identify ~ b1*nfcc_total_z + b2*mf_total_z + b3*norms_total_z + c_p*composite_political_orientation_z
...
exploratory3_paths <- rbind(c("nfcctotalz_composite_political_orientation_z", "zingroupminusoutgroupidentify_nfcc_total_z"),
                             c("mftotalz_composite_political_orientation_z", "zingroupminusoutgroupidentify_mf_total_z"),
                             c("normstotalz_composite_political_orientation_z", "zingroupminusoutgroupidentify_norms_total_z"))

reportbayesmediation(model = exploratory3_bayesmodel,
                     abpaths = exploratory3_paths,
                     directpath = "zingroupminusoutgroupidentify_composite_political_orientation_z")
