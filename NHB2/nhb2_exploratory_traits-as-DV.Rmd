---
title: 'Exploratory Analyses NHB2: Evaluative Traits as DV'
...
exploratory1_bayesmodel_default <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_default_traits-as-DV"
  )
...
exploratory1_priordraws_default<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_priordraws_default_traits-as-DV"
  )
...
exploratory1_bayesmodel_informed <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_informed_traits-as-DV"
  )
...
exploratory1_priordraws_informed<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory1_bayesmodel_priordraws_informed_traits-as-DV"
  )                            
```
...
exploratory2_bayesmodel_default <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_default_traits-as-DV"
)
...
exploratory2_priordraws_default <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_priordraws_default_traits-as-DV")
...
exploratory2_bayesmodel_informed <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_informed_traits-as-DV"
)
...
exploratory2_priordraws_informed <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb2/exploratory2_bayesmodel_priordraws_informed_traits-as-DV")
...
* M2: `mf_total_z`
* M3: `norms_total_z`
* Y: `z_ingroup_minus_outgroup_traits_positive`
...
f4 <- brms::bf(z_ingroup_minus_outgroup_traits_positive ~ composite_political_orientation_z + nfcc_total_z + mf_total_z + norms_total_z)
...
exploratory3_bayesmodel <- brm(
  ...
  warmup = 5000,
  chains = 4,
  file = "./model-fits/nhb2/exploratory3_bayesmodel_mediation_traits-as-DV")

# Define frequentist mediation model
medmodel <- "
    z_ingroup_minus_outgroup_traits_positive ~ b1*nfcc_total_z + b2*mf_total_z + b3*norms_total_z + c_p*composite_political_orientation_z
...
exploratory3_paths <- rbind(c("nfcctotalz_composite_political_orientation_z", "zingroupminusoutgrouptraitspositive_nfcc_total_z"),
                             c("mftotalz_composite_political_orientation_z", "zingroupminusoutgrouptraitspositive_mf_total_z"),
                             c("normstotalz_composite_political_orientation_z", "zingroupminusoutgrouptraitspositive_norms_total_z"))

reportbayesmediation(model = exploratory3_bayesmodel,
                     abpaths = exploratory3_paths,
                     directpath = "zingroupminusoutgrouptraitspositive_composite_political_orientation_z")
