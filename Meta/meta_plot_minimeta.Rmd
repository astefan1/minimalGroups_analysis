...
studyeffects$study <- factor(studyeffects$study, 
                             ...
                             labels = rev(c("Prolific", "MTurk", "Condition: Random", "Condition: Attitude", "Conditon: Volitional", "Study 2", "Condition: No Interaction", "Condition: Competitive", "Condition: Cooperative", "Study 3", "Global Effect")))
```
