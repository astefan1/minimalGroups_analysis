---
title: 'Exploratory Analyses NHB1: Tajfel Points as DV'
...
confirmatory1_formula <- z_total_ingroup_minus_outgroup_points ~ composite_political_orientation_z
...
confirmatory1_bayesmodel <- brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb1/exploratory1_bayesmodel_points-as-DV"
)
...
confirmatory1_priordraws<- brms::brm(confirmatory1_formula, 
                            ...
                            refresh = 0,
                            iter = 100000,
                            file = "./model-fits/nhb1/exploratory1_bayesmodel_priordraws_points-as-DV")
```
...
confirmatory1a_bayesmodel <- brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb1/exploratory1a_bayesmodel_points-as-DV"
)
...
confirmatory1a_priordraws<- brms::brm(confirmatory1_formula, 
                            ...
                            refresh = 0,
                            iter = 100000,
                            file = "./model-fits/nhb1/exploratory1a_bayesmodel_priordraws_points-as-DV")
```
...
confirmatory1b_bayesmodel <- brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb1/exploratory1b_bayesmodel_points-as-DV"
)
...
confirmatory1b_priordraws<- brms::brm(confirmatory1_formula, 
                            ...
                            refresh = 0,
                            iter = 100000,
                            file = "./model-fits/nhb1/exploratory1b_bayesmodel_priordraws_points-as-DV")
```
...
```{r}
# Define model equation
confirmatory2_formula <- z_total_ingroup_minus_outgroup_points ~ composite_political_orientation_z + platform + composite_political_orientation_z:platform
...
confirmatory2_bayesmodel <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb1/exploratory2_bayesmodel_points-as-DV"
)
...
confirmatory2_priordraws <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb1/exploratory2_bayesmodel_priordraws_points-as-DV")
```
