---
title: 'Exploratory Analyses NHB3: Ideological Extremity'
...
```{r}
strel(nhb3[, c("z_PolOrientExtremity", "z_SocOrientExtremity", "z_EconOrientExtremity", "z_SECSExtremity")], estimates = "alpha")
```

The political extremity index shows excellent internal consistency ($\alpha$ = 0.81), so we will work with the index in the following analyses.
...
exploratory_freqmodel <- lm(exploratory_formula, nhb3)
...
exploratory_bayesmodel <- brms::brm(
  ...
  #refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory3_bayesmodel_extremity"
)
```
...
exploratory_bayesmodel <- brms::brm(
  ...
  #refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory3_bayesmodel_extremity-points-as-DV"
)
```
...
exploratory_bayesmodel <- brms::brm(
  ...
  #refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory3_bayesmodel_extremity-traits-as-DV"
)
```
...
exploratory_bayesmodel <- brms::brm(
  ...
  #refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory3_bayesmodel_extremity-identify-as-DV"
)
```
