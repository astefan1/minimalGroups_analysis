---
title: "Exploratory Analyses NHB3: Identification as DV"
...
exploratory1_bayesmodel_default <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory1_bayesmodel_default_identify-as-DV"
  )
...
exploratory1_priordraws_default<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb3/exploratory1_bayesmodel_priordraws_default_identify-as-DV"
  )
...
exploratory1_bayesmodel_informed <- brm(
  ...
  # refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory1_bayesmodel_informed_identify-as-DV"
  )
...
exploratory1_priordraws_informed<- brm(
  ...
  # refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb3/exploratory1_bayesmodel_priordraws_informed_identify-as-DV"
  )                            
```
...
exploratory2_bayesmodel_default <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory2_bayesmodel_default_identify-as-DV"
)
...
exploratory2_priordraws_default <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb3/exploratory2_bayesmodel_priordraws_default_identify-as-DV")
...
exploratory2_bayesmodel_informed <- brms::brm(
  ...
  refresh = 0,
  warmup = 5000,
  file = "./model-fits/nhb3/exploratory2_bayesmodel_informed_identify-as-DV"
)
...
exploratory2_priordraws_informed <- brms::brm(
  ...
  refresh = 0,
  iter = 100000,
  file = "./model-fits/nhb3/exploratory2_bayesmodel_priordraws_informed_identify-as-DV")
